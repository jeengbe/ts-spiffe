...
class X509SVIDRequest$Type extends MessageType<X509SVIDRequest> {
    ...
    create(value?: PartialMessage<X509SVIDRequest>): X509SVIDRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<X509SVIDRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: X509SVIDRequest): X509SVIDRequest {
...
class X509SVIDResponse$Type extends MessageType<X509SVIDResponse> {
    ...
    create(value?: PartialMessage<X509SVIDResponse>): X509SVIDResponse {
        ...
        if (value !== undefined)
            reflectionMergePartial<X509SVIDResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: X509SVIDResponse): X509SVIDResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    private binaryReadMap3(map: X509SVIDResponse["federatedBundles"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof X509SVIDResponse["federatedBundles"] | undefined, val: X509SVIDResponse["federatedBundles"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    internalBinaryWrite(message: X509SVIDResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.crl.length; i++)
            writer.tag(2, WireType.LengthDelimited).bytes(message.crl[i]);
        /* map<string, bytes> federated_bundles = 3; */
        for (let k of globalThis.Object.keys(message.federatedBundles))
            writer.tag(3, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.LengthDelimited).bytes(message.federatedBundles[k]).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class X509SVID$Type extends MessageType<X509SVID> {
    ...
    create(value?: PartialMessage<X509SVID>): X509SVID {
        ...
        message.hint = "";
        if (value !== undefined)
            reflectionMergePartial<X509SVID>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: X509SVID, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string spiffe_id = 1; */
        if (message.spiffeId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.spiffeId);
        /* bytes x509_svid = 2; */
        if (message.x509Svid.length)
            writer.tag(2, WireType.LengthDelimited).bytes(message.x509Svid);
        /* bytes x509_svid_key = 3; */
        if (message.x509SvidKey.length)
            writer.tag(3, WireType.LengthDelimited).bytes(message.x509SvidKey);
        /* bytes bundle = 4; */
        if (message.bundle.length)
            writer.tag(4, WireType.LengthDelimited).bytes(message.bundle);
        /* string hint = 5; */
        if (message.hint !== "")
...
class X509BundlesRequest$Type extends MessageType<X509BundlesRequest> {
    ...
    create(value?: PartialMessage<X509BundlesRequest>): X509BundlesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<X509BundlesRequest>(this, message, value);
        return message;
    }
...
class X509BundlesResponse$Type extends MessageType<X509BundlesResponse> {
    ...
    create(value?: PartialMessage<X509BundlesResponse>): X509BundlesResponse {
        ...
        message.bundles = {};
        if (value !== undefined)
            reflectionMergePartial<X509BundlesResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: X509BundlesResponse): X509BundlesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    private binaryReadMap2(map: X509BundlesResponse["bundles"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof X509BundlesResponse["bundles"] | undefined, val: X509BundlesResponse["bundles"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    internalBinaryWrite(message: X509BundlesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.crl.length; i++)
            writer.tag(1, WireType.LengthDelimited).bytes(message.crl[i]);
        /* map<string, bytes> bundles = 2; */
        for (let k of globalThis.Object.keys(message.bundles))
            writer.tag(2, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.LengthDelimited).bytes(message.bundles[k]).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class JWTSVIDRequest$Type extends MessageType<JWTSVIDRequest> {
    ...
    create(value?: PartialMessage<JWTSVIDRequest>): JWTSVIDRequest {
        ...
        message.spiffeId = "";
        if (value !== undefined)
            reflectionMergePartial<JWTSVIDRequest>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: JWTSVIDRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string spiffe_id = 2; */
        if (message.spiffeId !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.spiffeId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class JWTSVIDResponse$Type extends MessageType<JWTSVIDResponse> {
    ...
    create(value?: PartialMessage<JWTSVIDResponse>): JWTSVIDResponse {
        ...
        message.svids = [];
        if (value !== undefined)
            reflectionMergePartial<JWTSVIDResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JWTSVIDResponse): JWTSVIDResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
class JWTSVID$Type extends MessageType<JWTSVID> {
    ...
    create(value?: PartialMessage<JWTSVID>): JWTSVID {
        ...
        message.hint = "";
        if (value !== undefined)
            reflectionMergePartial<JWTSVID>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: JWTSVID, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string svid = 2; */
        if (message.svid !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.svid);
        /* string hint = 3; */
        if (message.hint !== "")
...
class JWTBundlesRequest$Type extends MessageType<JWTBundlesRequest> {
    ...
    create(value?: PartialMessage<JWTBundlesRequest>): JWTBundlesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<JWTBundlesRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JWTBundlesRequest): JWTBundlesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
class JWTBundlesResponse$Type extends MessageType<JWTBundlesResponse> {
    ...
    create(value?: PartialMessage<JWTBundlesResponse>): JWTBundlesResponse {
        ...
        message.bundles = {};
        if (value !== undefined)
            reflectionMergePartial<JWTBundlesResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JWTBundlesResponse): JWTBundlesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    private binaryReadMap1(map: JWTBundlesResponse["bundles"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof JWTBundlesResponse["bundles"] | undefined, val: JWTBundlesResponse["bundles"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    internalBinaryWrite(message: JWTBundlesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.bundles))
            writer.tag(1, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.LengthDelimited).bytes(message.bundles[k]).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ValidateJWTSVIDRequest$Type extends MessageType<ValidateJWTSVIDRequest> {
    ...
    create(value?: PartialMessage<ValidateJWTSVIDRequest>): ValidateJWTSVIDRequest {
        ...
        message.svid = "";
        if (value !== undefined)
            reflectionMergePartial<ValidateJWTSVIDRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ValidateJWTSVIDRequest): ValidateJWTSVIDRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ValidateJWTSVIDRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string audience = 1; */
        if (message.audience !== "")
...
class ValidateJWTSVIDResponse$Type extends MessageType<ValidateJWTSVIDResponse> {
    ...
    create(value?: PartialMessage<ValidateJWTSVIDResponse>): ValidateJWTSVIDResponse {
        ...
        message.spiffeId = "";
        if (value !== undefined)
            reflectionMergePartial<ValidateJWTSVIDResponse>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: ValidateJWTSVIDResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string spiffe_id = 1; */
        if (message.spiffeId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.spiffeId);
